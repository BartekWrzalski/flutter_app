...
class Liquors extends StatefulWidget {
  const Liquors({Key? key}) : super(key: key);

  @override
  _LiquorsState createState() => _LiquorsState();
}

class _LiquorsState extends State<Liquors> {
  List<Product> products = Product.products.where((e) => e.category == Category.Liqueur).toList();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Wina i likiery"),
      ),
      body: ListView(
