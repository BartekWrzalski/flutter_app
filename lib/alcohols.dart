...
class Alcohols extends StatefulWidget {
  const Alcohols({Key? key}) : super(key: key);

  @override
  _AlcoholsState createState() => _AlcoholsState();
}

class _AlcoholsState extends State<Alcohols> {
  List<Product> products = Product.products.where((e) => e.category == Category.Alcohol).toList();

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Alkohole mocne"),
      ),
      body: ListView(
